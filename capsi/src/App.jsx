...
function App() {
  ...
  return (
    <>
      ...
      <h1>Welcome to CAPSI, the Continental Action Plan for Sustainable Industry</h1>
      <h3>Where stakeholders throughout North America redesign sustainable industrial systems that work for everyone.</h3>
      ...
      <h2>What do we mean by sustainable?</h2>
